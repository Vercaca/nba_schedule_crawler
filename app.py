...
app = Flask(__name__)
app.config['SQLALCHEMY_DATABASE_URI'] = 'postgres://bmkbedgyimciho:2adc6fdaeededfcdad44bc0c665cf958ec93404cc6c16a9cc9b8f23a084dd0e6@ec2-54-83-201-84.compute-1.amazonaws.com:5432/ddb09rrkbo8a19a'
db = SQLAlchemy(app)
